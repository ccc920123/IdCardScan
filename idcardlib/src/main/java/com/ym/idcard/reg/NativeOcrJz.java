...
public class NativeOcrJz {
  ...
  public NativeOcrJz(Handler var1) {
    mHandler = var1;
  }
  ...
  public native long SaveImageJpg(long var1, byte[] var3);
  ...
  public native long SaveImage(long var1, long var3, byte[] var5);

  public native long GetImage(byte[] var1);
}
